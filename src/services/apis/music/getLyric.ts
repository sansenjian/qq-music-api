...
const getLyric = async ({ method = 'get', params = {}, option = {}, isFormat = false }: ApiOptions) => {
...
export default (props: ApiOptions) => observeService(
  'getLyric',
  { method: props.method, params: props.params, option: props.option },
  () => getLyric(props)
);
